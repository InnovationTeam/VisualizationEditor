<template>
    <div :class="['wx-video']" :data-wx-element-id="id">
        <video :id="id" class="video-js  vjs-big-play-centered" controls preload="auto" poster ref="videoDom" style="width:300px;height:225px">
            <source :src="cfgData.src" type='video/mp4'>
        </video>
        <slot></slot>
    </div>
</template>
